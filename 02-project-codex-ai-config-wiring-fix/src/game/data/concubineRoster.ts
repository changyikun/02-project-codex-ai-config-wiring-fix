...
const GENERATED_CONSORT_TEMPLATES: readonly GeneratedConcubineTemplate[] = [
  ...
  },
  {
    portraitId: '程雪砚',
    name: '程雪砚',
    familyBackground: '翰林掌书记之女',
    personality: '冷静善记',
    summary: '说话不多，却能把旁人一句半句都记进心里，最擅在旧账里找破绽。',
    ageRange: [17, 22],
    possibleRanks: ['才人', '贵人', '美人'],
    possibleResidences: ['披香殿西偏殿', '永宁宫东偏殿', '钟粹宫东偏殿'],
    stats: {
      prestige: 55,
      favor: 31,
      familyInfluence: 64,
  ...
  },
  {
    portraitId: '阿史那明珠',
    name: '阿史那明珠',
    familyBackground: '北境归附部族贵女',
    personality: '爽利好胜',
    summary: '不太会绕弯，却极看重输赢与承诺；若被人轻慢，反击也来得最快。',
    ageRange: [18, 23],
    possibleRanks: ['贵人', '嫔', '美人'],
    possibleResidences: ['长春宫西偏殿', '启祥宫西偏殿', '昭阳宫东偏殿'],
    stats: {
      prestige: 64,
      favor: 38,
      familyInfluence: 67,
  ...
  },
  {
    portraitId: '闻人照月',
    name: '闻人照月',
    familyBackground: '香药世家庶女',
    personality: '温软多疑',
    summary: '袖间常带淡香，面上温顺，心里却把每一次示好都反复称量。',
    ageRange: [16, 21],
    possibleRanks: ['美人', '贵人', '常在'],
    possibleResidences: ['延禧宫东偏殿', '临华殿东偏殿', '玉清宫西偏殿'],
    stats: {
      prestige: 53,
      favor: 45,
      familyInfluence: 50,
  ...
  },
  {
    portraitId: '周怜星',
    name: '周怜星',
    familyBackground: '钦天监少监侄女',
    personality: '敏感谨慎',
    summary: '常把天象、时辰与人心连在一起看，怕事却不糊涂，最容易提前察觉风向。',
    ageRange: [16, 20],
    possibleRanks: ['常在', '才人', '美人'],
    possibleResidences: ['钟粹宫东偏殿', '昭华殿西偏殿', '永宁宫西偏殿'],
    stats: {
      prestige: 47,
      favor: 29,
      familyInfluence: 48,
...
const TARGET_LIVE_CONSORT_COUNT = 12;
