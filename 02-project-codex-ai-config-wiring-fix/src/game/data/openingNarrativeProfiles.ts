...
> = {
  lanyinxuguo: {
    ...
    mapFeatureSummary: '养心殿牵着朝堂与御前进退，宝华殿管着祈福因果，后宫更关着人心去向。',
  ...
  yingluoyeting: {
    ...
    mapFeatureSummary: '冷宫旧案、太医院消息与后宫风声都可能是翻盘线索，养心殿与建章宫更要慎进。',
  ...
  chenyuansucuo: {
    ...
    mapFeatureSummary: '玉清宫、宫门与养心殿都牵着去留与权衡，宝华殿和太医院也常藏着别样转机。',
