...
export const CHRONICLE_UI_BACKGROUND = COMMON_MENU_PANEL_BACKGROUND;
export const MISC_INFO_UI_BACKGROUND = COMMON_MENU_PANEL_BACKGROUND;
export const BOND_UI_BACKGROUND = COMMON_MENU_PANEL_BACKGROUND;
export const AFFAIRS_UI_BACKGROUND = COMMON_MENU_PANEL_BACKGROUND;
export const INVENTORY_UI_BACKGROUND = COMMON_MENU_PANEL_BACKGROUND;
